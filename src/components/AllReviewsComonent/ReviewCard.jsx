        ...
        <div className="break-inside-avoid bg-custom-half-primary p-4 grid gap-5 rounded-md ">
            <div className="space-y-1">
                <h6 className="font-semibold">
                    {data.gameTitle} <span className="text-xs">({data.publishingYear})</span>
                </h6>
            ...
            <Link to={`/review/${data._id}`} className="primaryButton activePrimaryButton mx-auto h-fit">View Details</Link>
