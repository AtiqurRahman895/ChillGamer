                ...
                <div className="fromWrapper max-w-lg">
                    ...
                    <form onSubmit={CreatUserOnSubmit} className="card-body p-0">
                        ...
                        <button onClick={()=>setShowPassword(!showPassword)} type="button" className="btn btn-ghost btn-circle btn-sm absolute right-4 top-11">
                            {showPassword?<IoIosEye className="text-[20px] dark:text-white" />:<IoIosEyeOff className="text-[20px] dark:text-white" />}
                        </button>
                    ...
                    <button onClick={handleGoogleLoginBtn} className='btn btn-ghost border text-black dark:text-white'><img src={googleSVG} alt="" className='w-[1rem]'/> Login with Google</button> */}
